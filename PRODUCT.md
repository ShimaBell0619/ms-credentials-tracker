...
The initial UI baseline is established by PR #5. The current milestone introduces the first credential-domain logic and validates a browser-only Microsoft Learn Transcript paste-import path before server-side persistence, authentication, or Microsoft API integration is selected.
...
- parse copied Microsoft Learn Transcript text into import candidates
...
- direct scraping of Microsoft Learn share URLs
- PDF parsing
